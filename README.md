...
**Пройденные курсы и книги:**
- **Spring Framework** — полный видеокурс от Заура Трегулова (102 урока + Hibernate)
- **FastAPI + SQLAlchemy** — курс от Сурена Хореяна
- **Добрый, добрый Python. ООП** — курс от Сергея Балакирева (Stepik)
- **Python. К вершинам мастерства** — книга Лучано Рамальо (2-е издание, 898 страниц)

Интересуюсь веб-разработкой, архитектурой приложений и созданием надёжных масштабируемых систем.

## 🛠 Мой стек

**Languages**  
<img src="https://skillicons.dev/icons?i=python,java,cpp,postgres,mysql&perline=8" />

**Frameworks & Tools**  
<img src="https://skillicons.dev/icons?i=django,fastapi,docker,git,githubactions,redis,rabbitmq,linux&perline=8" />
